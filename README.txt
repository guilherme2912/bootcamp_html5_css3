...
Estrutura Basica
<!DOCTYPE html> = Diz ao navegador o que estamos dizendo.
<html>
 <head> = 
  <meta> = são os elementos que o navegador vai reconhecer EX: Charset 
  <title></title> = Titulo que vai na aba do navegador
 </head>
